...
export const siteConfig: SiteConfig = {
	...
	banner: {
		...
		src: {
			desktop: [
				"/assets/desktop-banner/card_after_training (2).png",
				"/assets/desktop-banner/card_after_training - 2025-11-19T203052.221.png",
				"/assets/desktop-banner/card_after_training (18).png",
				"/assets/desktop-banner/card_after_training (16).png",
				"/assets/desktop-banner/card_after_training - 2025-11-19T203022.124.png",
				"/assets/desktop-banner/card_after_training (69).png",
				"/assets/desktop-banner/card_after_training11.png",
				"/assets/desktop-banner/card_after_training - 2026-01-08T200936.264.png",
				"/assets/desktop-banner/card_after_training (15).png",
				"/assets/desktop-banner/webwxgetmsgimg_5.jpg",
				"/assets/desktop-banner/card_after_training (1).png",
				"/assets/desktop-banner/card_after_training (13).png",
			], // 桌面横幅图片
			mobile: [
				"/assets/desktop-banner/card_after_training (2).png",
				"/assets/desktop-banner/card_after_training - 2025-11-19T203052.221.png",
		...
		homeText: {
            ...
            subtitle: [
                ...
                "たとえ記憶が薄れても、心に刻まれた君の温もりは消えない",
            ],
            typewriter: {
                enable: true, // 启用副标题打字机效果
                speed: 100, // 打字速度（毫秒）
                deleteSpeed: 20, // 删除速度（毫秒）
...
export const announcementConfig: AnnouncementConfig = {
	title: "境界の備忘録", // 公告标题，填空使用i18n字符串Key.announcement
	content: "这里是一处被时间遗忘的避难所。\n浮空之岛上，堆叠着理性构筑的文字、应对命运审判的答卷，还有那些在午夜寂静时、从指缝间溜走的虚幻灵感。\n终究是要展翅远航的吧。在你的羽翼尚未丰满前，愿这些微弱的火光，能稍微温暖你疲惫的旅程。", // 公告内容
...
export const musicPlayerConfig: MusicPlayerConfig = {
	...
	meting_api:
		"https://meting-api.zhuangzhuang.io:443//api?server=netease&type=playlist&id=7991458296",
	id: "17761554676", // 歌单ID
...
export const footerConfig: FooterConfig = {
	...
	customHtml: "桜のように散る運命だとしても、せめて美しく咲き誇れ", // HTML格式的自定义页脚信息，例如备案号等，默认留空
